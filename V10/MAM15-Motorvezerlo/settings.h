...
#define DEBUG_LED_FLASH true       // LED Flash toggle logolása
...
// ═════════════════════════════════════════════════════════
// LED FLASH BEÁLLÍTÁSOK (Landoló gomb második funkciója)
// ═════════════════════════════════════════════════════════
#define LED_FLASH_PIN 22           // Toggle kimenet pin
...
#define SPEED_LEVEL_3 40           // Lassú sebesség
